    ...
    <div className="group relative">
      {showLeftArrow && (
        <>
          ...
          <div
            className={`from-background absolute inset-y-0 left-0 z-10 w-30 bg-gradient-to-r to-transparent ${!showLeftArrow ? 'opacity-0' : ''}`}
          />
        </>
      )}
      ...
      {showRightArrow && (
        <>
          ...
          <div
            className={`from-background absolute inset-y-0 right-0 z-10 w-30 bg-gradient-to-l to-transparent ${!showRightArrow ? 'opacity-0' : ''}`}
          />
        </>
      )}
    </div>
