/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 65f6f8d15073f49a41c827c948995f59)
// Runtime types generated with workerd@1.20250902.0 2025-09-06 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_POSTHOG_KEY: string;
		NEXT_PUBLIC_POSTHOG_HOST: string;
		NEXT_PUBLIC_IMAGEKIT_ID: string;
		...
		MOVIE_DB_ACCESS_TOKEN: string;
		NEXT_PUBLIC_CLOUDFLARE_PROXY_BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "NEXT_PUBLIC_IMAGEKIT_ID" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_TRUSTED_ORIGIN" | "DATABASE_URL" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "MOVIE_DB_ACCESS_TOKEN" | "NEXT_PUBLIC_CLOUDFLARE_PROXY_BASE_URL">> {}
}
